...
<link href="/borrowers/web/bundles/borrowershome/css/bandl5.css" type="text/css" rel="stylesheet"/>
<script type="text/javascript" src="/borrowers/web/bundles/borrowershome/js/nav.js"/>
<script type="text/javascript" src="/borrowers/web/bundles/borrowershome/js/overlib.js">
...
<img src='/borrowers/web/bundles/borrowershome/img/bodyspacer.gif'/>

<div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"/>

<xsl:for-each select='body/essayTitle'>
<p class='essaytitle'><xsl:apply-templates/></p>
</xsl:for-each>
...
<a href='#abstract'><xsl:text>Abstract | </xsl:text></a>
</xsl:if>
<xsl:for-each select="//subTitle">
<xsl:variable name='subtitle'>
<xsl:text>#subtitle</xsl:text><xsl:number level="any"/>
</xsl:variable>
<a href='{$subtitle}'><xsl:apply-templates/></a>
...
<a href='#notes'><xsl:text>Notes </xsl:text></a>
...
<xsl:if test="count(//refitem) != 0">
<a href='#references'><xsl:text>References </xsl:text></a>
</xsl:if>

<xsl:if test="count(//onlineresourceitem) != 0">
<xsl:text> | </xsl:text>
<a href='#onlineresources'><xsl:text>Online Resources </xsl:text></a>
</xsl:if>
</p>
<!-- end of navigation -->
...
<xsl:if test="count(//note) != 0">
<a name='notes'/>
<p class='title'><xsl:text>Notes</xsl:text></p>
</xsl:if>
<xsl:for-each select='//note'>
<xsl:variable name='notetext'>
<xsl:text>n</xsl:text><xsl:number level="any"/>
</xsl:variable>
<xsl:variable name='notereturn'>
<xsl:text>#nr</xsl:text><xsl:number level="any"/>
</xsl:variable>
<a name='{$notetext}'/>
<table>
<tr>
...
<br/><br/>
<a name='references'/>
<p class='title'><xsl:text>References</xsl:text></p>
<xsl:apply-templates/>
</xsl:if>
</xsl:for-each>
...
<p class='title'><xsl:text>Online Resources</xsl:text></p>
<xsl:apply-templates/>
</xsl:if>
</xsl:for-each>
...
<br/>
<p class='title'><xsl:text>Permissions</xsl:text></p>
<xsl:apply-templates/>
</xsl:if>
</xsl:for-each>
...
<xsl:text> | </xsl:text>
<a href='#top'><xsl:text>Top </xsl:text></a>
</p>
<hr/>
<!-- end of navigation -->
...
&#169; Borrowers and Lenders 2005-2012
<br/>
</p>
...
<a name='{$subTitleText}'/>
 <p class='title'><a href="#top"><xsl:apply-templates/></a></p>
...
<xsl:apply-templates/>
<a class='wc' href="#{@refid}" onmouseover="return overlib('{$source}');" onmouseout="return nd();">
<xsl:value-of select='$citation'/></a>
</td></tr></table>-->

<xsl:choose>
<xsl:when test='count(line) != 0'>
<table class='verse'><tr><td>
<a class='wc' href="#{@refid}" onmouseover="return overlib('{$source}');" onmouseout="return nd();">
<xsl:apply-templates/></a><xsl:value-of select='$citation'/>
</td></tr></table>
</xsl:when>
<xsl:otherwise>
<table class='quote'><tr><td>
...
<!--parenthetical mounseover
 <xsl:text>"</xsl:text>
 <xsl:choose>
 <xsl:when test="substring(., string-length(.)-0) = '.'">
 <xsl:value-of select="substring(., 1, string-length(.)-1)"/>
 <xsl:text>" </xsl:text>
  <a class='wc' href="#{@refid}" onmouseover="return overlib('{$source}');" onmouseout="return nd();"><xsl:value-of select='$citation'/></a><xsl:text>. </xsl:text>
 </xsl:when>
 ...
 -->
   <a class='wc' href="#{@refid}" onmouseover="return overlib('{$source}');" onmouseout="return nd();"><xsl:apply-templates/></a>
</xsl:template>
...
<a name="{@refid}"/>
<p class="wc"><xsl:apply-templates/></p>
</xsl:template>

<xsl:template match="onlineresourceitem">
 <p class="or"><xsl:apply-templates/></p>
</xsl:template>
...
<a href='{$note}'><sup><b><xsl:number level="any"/><a name='{$notereturn}'/></b></sup></a>
</xsl:template>
...
<xsl:template match="refitem/titleOfLongWork">
 <xsl:text> </xsl:text><span class='italics'><xsl:apply-templates/></span>
</xsl:template>
