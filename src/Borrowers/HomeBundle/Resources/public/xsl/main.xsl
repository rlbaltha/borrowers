...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <p class='footer'>
                ...
                &#169; Borrowers and Lenders 2005-2015
                <br/>
            </p>
    ...
    <xsl:template match="note/inlineQuote">
        ...
        <a class='wc' href="#{@refid}"  data-container="body" data-toggle="popover" data-placement="right" data-content="{$source}" data-trigger="hover"><xsl:apply-templates/></a>
    </xsl:template>
